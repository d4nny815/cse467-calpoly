...
void test_hash_set_contains() {
    ...
    int result1 = hash_set_contains(hs, key1);
    int result2 = hash_set_contains(hs, key2);
    int result3 = hash_set_contains(hs, key3);
...
void test_hash_set_get_items() {
    ...
    assert(items[2].key == key3);
    assert(*(int*)items[0].value == element1);
    assert(*(int*)items[1].value == element2);
    assert(*(int*)items[2].value == element3);
...
void test_hash_set_update() {
    ...
    int new_element1 = 100;
    int new_element2 = 200;
    int new_element3 = 300;
